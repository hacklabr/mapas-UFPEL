...
return [
    "text:home-header.title" => i::__("Boas-vindas ao Mapa Cultural de Pelotas"),
    "text:home-header.description" => i::__("O Mapa Cultural de Pelotas é uma ferramenta de gestão cultural que garante a estruturação de Sistemas de Informações e Indicadores."),
    ...
    "text:home-register.title" => i::__("Faça seu cadastro e colabore com o Mapa Cultural de Pelotas"),
    ...
    'text:home-developers.description' => 'Além disso, Mapa cultural de Pelotas é um software livre, criado em parceria entre a hacklab/, secretarias de cultura, organizações não governamentais, empresas e coletivos que investem na plataforma. Você pode contribuir para o seu desenvolvimento através do GitHub.',
