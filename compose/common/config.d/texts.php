...
return [
    "text:home-header.title" => i::__("Boas-vindas ao Mapa Cultural AGIMOS da Universidade Federal de Pelotas"),
    "text:home-header.description" => i::__("O Mapa Cultural AGIMOS é uma ferramenta de gestão cultural da Agência de Indústria Criativa e Mobilização Social da UFPEL que busca a estruturação de produções culturais e políticas públicas para o setor."),
    ...
    "text:home-register.title" => i::__("Faça seu cadastro e colabore com o Mapa Cultural AGIMOS"),
    ...
    'text:home-developers.description' => 'Além disso, Mapa cultural AGIMOS é um software livre, criado em parceria entre a hacklab/, secretarias de cultura, organizações não governamentais, empresas e coletivos que investem na plataforma. Você pode contribuir para o seu desenvolvimento através do GitHub.',
